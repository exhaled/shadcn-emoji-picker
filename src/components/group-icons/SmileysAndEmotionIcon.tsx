/**
 * Obtain from Google Fonts Noto Emoji
 * Source: https://github.com/googlefonts/noto-emoji/blob/main/svg/emoji_u1f600.svg
 * 😀
 */
export const SmileysAndEmotionIcon = () => (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
		<g>
			<radialGradient
				id="SmileysAndEmotionColorIconGradient1"
				cx="63.22"
				cy="216.9"
				r="56.9597"
			...
			>
				<stop offset="0.5" style={{ stopColor: '#FDE030' }} />
				<stop offset="0.92" style={{ stopColor: '#F7C02B' }} />
				<stop offset="1" style={{ stopColor: '#F4A223' }} />
			</radialGradient>
			<path
				style={{ fill: 'url(#SmileysAndEmotionColorIconGradient1)' }}
				d="M63.22,118.8c-27.9,0-58-17.5-58-55.9S35.32,7,63.22,7c15.5,0,29.8,5.1,40.4,14.4
		c11.5,10.2,17.6,24.6,17.6,41.5s-6.1,31.2-17.6,41.4C93,113.6,78.62,118.8,63.22,118.8z"
			/>
			<path
				style={{ fill: '#422B0D' }}
				d="M44,40.94L44,40.94c-4.19,0-8,3.54-8,9.42s3.81,9.41,8,9.41l0,0c4.2,0,8-3.54,8-9.41
		S48.24,40.94,44,40.94z"
			/>
			<g>
				<path
					style={{ fill: '#896024' }}
					d="M43.65,44.87L43.65,44.87c-1.42-0.68-3.13-0.08-3.82,1.34c-0.53,1.11-0.29,2.44,0.6,3.3l0,0
			c1.42,0.68,3.13,0.08,3.82-1.34C44.78,47.06,44.54,45.73,43.65,44.87z"
				/>
			</g>
			<path
				style={{ fill: '#422B0D' }}
				d="M82.4,40.94L82.4,40.94c-4.19,0-8,3.54-8,9.42s3.81,9.41,8,9.41l0,0c4.19,0,8-3.54,8-9.41
		S86.59,40.94,82.4,40.94z"
			/>
			<g>
				<path
					style={{ fill: '#896024' }}
					d="M82,44.87L82,44.87c-1.42-0.68-3.13-0.08-3.82,1.34c-0.53,1.11-0.29,2.44,0.6,3.3l0,0
			c1.42,0.68,3.13,0.08,3.82-1.34C83.13,47.06,82.89,45.73,82,44.87z"
				/>
			</g>
			<path
				style={{ fill: '#EB8F00' }}
				d="M111.49,29.67c5.33,8.6,8.11,18.84,8.11,30.23c0,16.9-6.1,31.2-17.6,41.4
		...
		c11.5-10.2,17.6-24.5,17.6-41.4C121.6,50.16,118.13,38.84,111.49,29.67z"
			...
			<path
				style={{ fill: '#422B0D' }}
				d="M102.07,71.62c-1.4-2.53-4.44-3.64-7.14-2.62c-10.26,2.99-20.9,4.48-31.59,4.43
		...
		c6.42,14.1,20.57,22.54,37.87,22.59h0.16c17.3,0,31.45-8.49,37.88-22.59C102.44,77,103.43,74.13,102.07,71.62z"
			...
			<path
				style={{ fill: '#ED7770' }}
				d="M79.35,98.14c-0.37-0.34-0.75-0.65-1.13-1c-4.08-3.59-9.36-5.52-14.8-5.41
		...
		c5.66,0,11.27-1.01,16.57-3C79.84,98.84,79.61,98.48,79.35,98.14z"
			...
			<path
				style={{ fill: '#FFFFFF' }}
				d="M94.93,69c-10.26,2.99-20.9,4.48-31.59,4.43C52.65,73.48,42.01,71.99,31.75,69
		...
		"
			...
			<path
				style={{ fill: '#EB8F00' }}
				d="M102.11,71.63c-1.42-2.53-4.47-3.65-7.19-2.63c-10.26,2.99-20.9,4.48-31.58,4.43
